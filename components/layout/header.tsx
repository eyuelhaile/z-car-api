...
export function Header() {
  ...
  const compareCount =
    (vehicleCart?.listingIds?.length || 0) + (propertyCart?.listingIds?.length || 0);

  const needsVerification =
    isAuthenticated && user && !user.verified && !user.phoneVerified;
  ...
  return (
    <>
      {needsVerification && (
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 py-2.5 px-4 text-white">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm">
                ...
                <span className="hidden sm:inline">
                  Get verified to boost your credibility and assist us in creating trust amongst our users!
                </span>
              </p>
            </div>
            <Button
              size="sm"
              variant="secondary"
              className="shrink-0 bg-white font-semibold text-blue-700 hover:bg-blue-50"
              ...
              <>
                <Link href="/dashboard/favorites">
                  <Button variant="ghost" size="icon" className="relative text-muted-foreground">
                    ...
                    {counts.favorites > 0 && (
                      <Badge className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center bg-pink-500 p-0 text-[10px]">
                ...
                <Link href="/compare?type=vehicle">
                  <Button variant="ghost" size="icon" className="relative text-muted-foreground">
                    ...
                    {compareCount > 0 && (
                      <Badge className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center bg-blue-500 p-0 text-[10px]">
                ...
                <Link href="/dashboard/messages">
                  <Button variant="ghost" size="icon" className="relative text-muted-foreground">
                    ...
                    {counts.messages > 0 && (
                      <Badge className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center bg-amber-500 p-0 text-[10px]">
                ...
                <Link href="/dashboard/notifications">
                  <Button variant="ghost" size="icon" className="relative text-muted-foreground">
                    ...
                    {counts.notifications > 0 && (
                      <Badge className="absolute -right-1 -top-1 flex h-5 w-5 items-center justify-center bg-red-500 p-0 text-[10px]">
                  ...
                  {isAuthenticated && user ? (
                    <div className="flex flex-col gap-2">
                      ...
                      {(user.role === 'private' ||
                        user.role === 'broker' ||
                        user.role === 'dealership') && (
                        <Link href="/dashboard/listings/create" onClick={() => setMobileMenuOpen(false)}>
                          <Button className="mt-2 w-full gap-3 bg-gradient-to-r from-amber-500 to-orange-600">
